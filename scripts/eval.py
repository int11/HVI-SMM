...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight_path', type=str, default="weights/lolv2_syn/v5/20260103_144327_gt_mean_loss='hvi'/epoch_290.pth", help='Path to the pre-trained model weights')
